...
package org.apache.royale.foundation.svg
{
	...
	public class Rectangle extends GraphicBase
	{
		public function Rectangle()
		{
			super();
			addClassName("Rectangle");
		}
		...
		{
			_shape = document.createElementNS('http://www.w3.org/2000/svg', 'rect') as WrappedHTMLElement;
		...
		override public function addedToParent():void
		{
			...
			_shape.setAttribute('x', '0');
			_shape.setAttribute('y', '0');
			_shape.setAttribute('width', '100%');
			_shape.setAttribute('height', '100%');
		}
	}
}
