...
package org.apache.royale.simple.controls.controllers
{
	...
	/**
	 * The ToggleButtonMouseController watches for mouse related events on its
	 * strand and dispatches a change (and potentially other) events.
	 */
	public class ToggleButtonMouseController extends EventDispatcher implements IBeadController
	{
		public function ToggleButtonMouseController()
		{
			super();
		}
