...
package org.apache.royale.simple.controls.tableClasses
{
	...
	/**
	 * The DataTable$Header creates a header group within the DataTable. The
	 * $ in the name indicates this is really an internal use class.
	 */
	public class DataTable$Header extends UIComponent
	{
		public function DataTable$Header()
		{
			super();
		}
		...
		{
			this.element = document.createElement('thead') as WrappedHTMLElement;
